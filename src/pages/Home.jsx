            ...
            <div className="hero">
                <div className='hero__text'>
                    ...
                    <div className="hero__description">
                        <p>
                            In the hills where the Great Lotus Born was enlightened, where <br /> beneath lies the Kathmandu valley
                        </p>
                        ...
                        <div className="AboutRepaRetreat__content">
                            ...
                            <div className="AboutRepaRetreat__description">
                                <p className="AboutRepaRetreat__description-paragraph">
                                    Repa Retreat is an extraordinary place for meditation, healing and connecting.
                                    Its tranquil and secluded location overlooking the Kathmandu valley makes it
                                    ideal for both group retreats as well as solitary retreats.
                                </p>
                            </div>
                            <button
                                type="button"
                            ...
                            >
                                <svg className='AboutRepaRetreat__button-arrowbutton' width="8" height="13" viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0.292969 0.292847C0.683493 -0.0976776 1.31651 -0.0976776 1.70703 0.292847L6.90332 5.48914C7.14568 5.73163 7.23633 6.06738 7.17773 6.38074C7.23679 6.69439 7.14594 7.03056 6.90332 7.27332L1.70703 12.4696C1.31653 12.86 0.683468 12.86 0.292969 12.4696C-0.0974204 12.0791 -0.0974211 11.446 0.292969 11.0555L4.9668 6.38074L0.292969 1.70691C-0.0975555 1.31638 -0.0975555 0.683371 0.292969 0.292847Z" fill="rgba(255, 255, 255, 1)" />
                                </svg>
                                LEARN MORE
                            </button>
                        </div>
                    ...
                    <div className="services">
                        ...
                        <div className="services__content">
                            <div className="services__left">
                                ...
                                >
                                    <svg className='services__button-arrowbutton' width="8" height="13" viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0.292969 0.292847C0.683493 -0.0976776 1.31651 -0.0976776 1.70703 0.292847L6.90332 5.48914C7.14568 5.73163 7.23633 6.06738 7.17773 6.38074C7.23679 6.69439 7.14594 7.03056 6.90332 7.27332L1.70703 12.4696C1.31653 12.86 0.683468 12.86 0.292969 12.4696C-0.0974204 12.0791 -0.0974211 11.446 0.292969 11.0555L4.9668 6.38074L0.292969 1.70691C-0.0975555 1.31638 -0.0975555 0.683371 0.292969 0.292847Z" fill="rgba(255, 255, 255, 1)" />
                                    </svg>
                            ...
                            <div className="services__right">
                                <p className="services__invite-title">
                                    We invite you to join us in this transformative path of growth and enlightenment.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="language">
                        <div className="language__nepalilanguage">
                            ...
                            <div className="nepalilanguage__label ">
                                <label >Repa Program in <span className="nepalilanguage__label-span">Nepali Language</span></label>
                            </div>
                            <div className="nepalilanguage__learnMore ">
                                <button className='nepalilanguage__learnMore-btn'>
                                    <svg className='nepalilanguage__learnMore-arrowbutton' width="8" height="13" viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0.292969 0.292847C0.683493 -0.0976776 1.31651 -0.0976776 1.70703 0.292847L6.90332 5.48914C7.14568 5.73163 7.23633 6.06738 7.17773 6.38074C7.23679 6.69439 7.14594 7.03056 6.90332 7.27332L1.70703 12.4696C1.31653 12.86 0.683468 12.86 0.292969 12.4696C-0.0974204 12.0791 -0.0974211 11.446 0.292969 11.0555L4.9668 6.38074L0.292969 1.70691C-0.0975555 1.31638 -0.0975555 0.683371 0.292969 0.292847Z" fill="rgba(255, 255, 255, 1)" />
                                    </svg>
                                    LEARN MORE
                                </button>
                        ...
                        <div className="language__chineselanguage">
                            ...
                            <div className="chineselanguage__label ">
                                <label >Repa Program in <span className="chineselanguage__label-span">Chinese Language</span></label>
                            </div>
                            <div className="chineselanguage__learnMore ">
                                <button className='chineselanguage__learnMore-btn'>
                                    <svg className='chineselanguage__learnMore-arrowbutton' width="8" height="13" viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0.292969 0.292847C0.683493 -0.0976776 1.31651 -0.0976776 1.70703 0.292847L6.90332 5.48914C7.14568 5.73163 7.23633 6.06738 7.17773 6.38074C7.23679 6.69439 7.14594 7.03056 6.90332 7.27332L1.70703 12.4696C1.31653 12.86 0.683468 12.86 0.292969 12.4696C-0.0974204 12.0791 -0.0974211 11.446 0.292969 11.0555L4.9668 6.38074L0.292969 1.70691C-0.0975555 1.31638 -0.0975555 0.683371 0.292969 0.292847Z" fill="rgba(255, 255, 255, 1)" />
                                    </svg>
                                    LEARN MORE
                                </button>
                        ...
                        <div className="language__englishlanguage">
                            ...
                            <div className="englishlanguage__label ">
                                <label >Repa Program in <span className="englishlanguage__label-span">English Language</span></label>
                            </div>
                            <div className="englishlanguage__learnMore ">
                                <button className='englishlanguage__learnMore-btn'>
                                    <svg className='englishlanguage__learnMore-arrowbutton' width="8" height="13" viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0.292969 0.292847C0.683493 -0.0976776 1.31651 -0.0976776 1.70703 0.292847L6.90332 5.48914C7.14568 5.73163 7.23633 6.06738 7.17773 6.38074C7.23679 6.69439 7.14594 7.03056 6.90332 7.27332L1.70703 12.4696C1.31653 12.86 0.683468 12.86 0.292969 12.4696C-0.0974204 12.0791 -0.0974211 11.446 0.292969 11.0555L4.9668 6.38074L0.292969 1.70691C-0.0975555 1.31638 -0.0975555 0.683371 0.292969 0.292847Z" fill="rgba(255, 255, 255, 1)" />
                                    </svg>
                                    LEARN MORE
                                </button>
            ...
            <section className="repaProgram">
                <div className="repaProgram__summary">
                    ...
                    <div className="repaProgram__description right__summary">
                        <p>The Repa Program is divided into two main phases: preliminary and advanced practices. The preliminary <br /> phase lasts 1 year and 4 months, while the entire <br />program spans 7 years.</p>
                        <button>
                ...
                <div className="practices">
                        ...
                        <div className="practices__image-summary">
                            <div className="practices__image-context">
                                <div className="practices__header">
                                    <h1>Preliminary <span className="practices__header-span">Practices</span></h1>
                                </div>
                                <div className="practices__description">
                                    <p>The Repa Program is divided into two main phases: preliminary and advanced practices. The preliminary phase lasts 1 year and 4 months, while the entire program spans 7 years.</p>
                                    <button
                                        type="button"
                                        aria-label="Open navigation menu"
                                        className="practices__button"
                                    >
                                        <svg className='practices__button-arrowbutton' width="8" height="13" viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0.292969 0.292847C0.683493 -0.0976776 1.31651 -0.0976776 1.70703 0.292847L6.90332 5.48914C7.14568 5.73163 7.23633 6.06738 7.17773 6.38074C7.23679 6.69439 7.14594 7.03056 6.90332 7.27332L1.70703 12.4696C1.31653 12.86 0.683468 12.86 0.292969 12.4696C-0.0974204 12.0791 -0.0974211 11.446 0.292969 11.0555L4.9668 6.38074L0.292969 1.70691C-0.0975555 1.31638 -0.0975555 0.683371 0.292969 0.292847Z" fill="rgba(255, 255, 255, 1)" />
                                        </svg>
                                        LEARN MORE
                                    </button>
                    ...
                    <div className="practices__advanced">
                        <div className="advancedpractices__image-summary">
                            <div className="practices__image-context">
                                <div className="practices__header">
                                    <h1>Advanced <span className="practices__header-span">Practices</span></h1>
                                </div>
                                <div className="practices__description">
                                    <p>The Repa Program is divided into two main phases: preliminary and advanced practices. The preliminary phase lasts 1 year and 4 months, while the entire program spans 7 years.</p>
                                    <button
